...
public final class ItemMapper {
     ...
     */
    static Item mapToDomainForCreation(ItemCreateDTO itemCreateDTO, Long ownerId) {
        if (ownerId == null) {
     ...
     */
    static void updateFromDTO(ItemUpdateDTO itemUpdateDTO, Item item) {
     ...
     */
    static List<ItemResponseDTO> mapToResponseDTOList(Collection<Item> items) {
        return items.stream()
